...
const spinner2 = { 
  "interval": 150,
  "frames": ["CANAL DO CRIADOR: M.Scheyot💎"]}
...
const banner2 = cfonts.render(('Canal do criador: (M.Scheyot)'), {
font: 'console',
align: 'center',
gradrient: [`${cor4}`,`${cor2}`], 
...
const banner3 = cfonts.render((`SAKURA  BOT-V3 `), {
font: 'block',             
align: 'center',           
